...
$(function () {
    var playerTrack = $("#player-track"), bgArtwork = $('#bg-artwork'), bgArtworkUrl, albumName = $('#album-name'), trackName = $('#track-name'), albumArt = $('#album-art'), sArea = $('#s-area'),
        ...
        nTime = 0, buffInterval = null, tFlag = false, albums = ['Sowwyz', 'Sowwyz', 'Sowwyz', 'Breaking me', 'Why am I so in love'],
        trackNames = ['Sowwyz', 'Sowwyz', 'Sowwyz', 'Sowwyz', 'Chungus'], albumArtworks = ['_1', '_2', '_3', '_4', '_5'],
        trackUrl ='https://dl.baarzesh.net/music/2020/7/Topic_Breaking_Me_Remix_128.mp3', 'https://dl.baarzesh.net/music/2020/10/XXXTENTACION_the_remedy_for_a_broken_heart_320.mp3'],
